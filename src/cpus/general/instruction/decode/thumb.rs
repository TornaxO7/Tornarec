    ...
    fn from(decode_data: DecodeData<'a>) -> Self {
        match ThumbInstructionChecker::from(&decode_data.instruction) {
            ...
            ThumbInstructionChecker::AddSubtractCompareMoveImmediate => {
                Self::AddSubtractCompareMoveImmediate(AddSubtractCompareMoveImmediate::from(
                    decode_data,
                ))
            }
            ...
            ThumbInstructionChecker::LoadStoreWordByteImmediateOffset => {
                Self::LoadStoreWordByteImmediateOffset(LoadStoreWordByteImmediateOffset::from(
                    decode_data,
                ))
            }
            ThumbInstructionChecker::LoadStoreHalfwordImmediateOffset => {
                Self::LoadStoreHalfwordImmediateOffset(LoadStoreHalfwordImmediateOffset::from(
                    decode_data,
                ))
            }
            ...
            ThumbInstructionChecker::Miscellaneous(miscellaneous_instruction) => {
                match miscellaneous_instruction {
            ...
            ThumbInstructionChecker::UndefinedInstruction => Self::UndefinedInstruction,
            ...
            ThumbInstructionChecker::BlxSuffix => Self::BlxSuffix(BlxSuffix::from(decode_data)),
            ThumbInstructionChecker::BlOrBlxPrefix => {
                Self::BlOrBlxPrefix(BlOrBlxPrefix::from(decode_data))
            }
            ThumbInstructionChecker::BlSuffix => Self::BlSuffix(BlSuffix::from(decode_data)),
        }
    }
}
